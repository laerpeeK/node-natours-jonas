        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'https://laerpeek.top:5000/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'https://laerpeek.top:5000/api/v1/users/logout'
            });
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGFlcnBlZWsiLCJhIjoiY2xhaHQ2NmZmMDE2ZTNvb2JxdTJybXo5MCJ9.WdJXVtqABcjr5cc7IYjKKQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/laerpeek/claht9c1r000214mxqs6srnu1',
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'https://laerpeek.top:5000/api/v1/users/updateMyPassword' : 'https://laerpeek.top:5000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe("pk_test_51M5lFhEY5VB3iQh4WyZUPcwFF9pbhMwW40O3YAjVUhA4rSWK3BLCcLl14kUae3q2caAeI64wPiPqkg6h7CnHX8co00eagaiUUB");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "https://laerpeek.top:5000/api/v1/bookings/checkout-session/".concat(tourId)
            });
